...
class NanoDetPlus(OneStageDetector):
    def __init__(
        ...
        #print('==============',sum([torch.numel(i) for i in self.backbone.parameters()] + [torch.numel(i) for i in self.fpn.parameters()] + [torch.numel(i) for i in self.head.parameters()])/1024/1024)
